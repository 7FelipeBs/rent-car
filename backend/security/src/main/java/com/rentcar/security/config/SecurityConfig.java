package com.rentcar.security.config;

import com.rentcar.security.config.authentication.AuthEntryPointJwt;
import com.rentcar.security.config.authentication.AuthTokenFilters;
...
public class SecurityConfig {
    ...
    public AuthTokenFilters authenticationJwtTokenFilter() {
        return new AuthTokenFilters(jwtUtil(), usersDetailsService);
    }
